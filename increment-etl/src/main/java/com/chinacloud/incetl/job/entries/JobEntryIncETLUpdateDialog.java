...
public class JobEntryIncETLUpdateDialog extends JobEntryDialog implements JobEntryDialogInterface {
  ...
  private JobEntryIncETLUpdate jobEntry;
  private Shell shell;
  ...
  public JobEntryIncETLUpdateDialog( Shell parent, JobEntryInterface jobEntryInt, Repository rep, JobMeta jobMeta ) {
    super( parent, jobEntryInt, rep, jobMeta );
    jobEntry = (JobEntryIncETLUpdate) jobEntryInt;
    if ( this.jobEntry.getName() == null ) {
      this.jobEntry.setName("作业增量信息更新");
    }
  }
  ...
  public JobEntryInterface open() {
    ...
    this.wlDescription.setText("说明");
    this.props.setLook(this.wlDescription);
    this.fdlDescription = new FormData();
    this.fdlDescription.left = new FormAttachment(0, 0);
    this.fdlDescription.right = new FormAttachment(middle, -margin);
    this.fdlDescription.top = new FormAttachment(this.wName, 8);//距上一个控件的位置
    ...
    this.wDescription.setText("你什么都不用做，谢谢！");
    this.wDescription.setEditable(false);
    this.wDescription.addModifyListener(lsMod);
    this.fdDescription = new FormData();
    this.fdDescription.left = new FormAttachment(middle, 0);
    this.fdDescription.right = new FormAttachment(100, 0);
    this.fdDescription.top = new FormAttachment(this.wName, 8);//距上一个控件的位置
